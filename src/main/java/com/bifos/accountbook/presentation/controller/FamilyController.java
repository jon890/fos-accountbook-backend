...
public class FamilyController {
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "201", description = "가족 생성 성공")
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "조회 성공")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "가족을 찾을 수 없음")
