...
class DashboardServiceBudgetExclusionTest extends TestFixturesSupport {
  ...
  void monthlyStats_ExpenseExcludeFlagTakesPrecedenceOverCategoryFlag() {
    ...
    com.bifos.accountbook.category.application.dto.UpdateCategoryRequest updateRequest =
        new com.bifos.accountbook.category.application.dto.UpdateCategoryRequest(
            null,
            null,
            null,
