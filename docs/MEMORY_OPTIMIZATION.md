...
- `MaxRAMPercentage`는 OOM 방지 목적
- 75% 설정으로 컨테이너 메모리(3GB)의 2.25GB 사용 가능, 25% 여유 공간 확보
- 실제 사용량이 적으면 리소스 절약 효과
...
1. **메모리 사용량 확인**
   ...
   - 모니터링 도구에서 메모리 사용량 추이 확인

2. **로그 확인**
   - 애플리케이션 로그에서 GC 로그 및 메모리 관련 에러 확인
...
- 애플리케이션 로그에서 문자열 중복 제거 관련 정보 확인
